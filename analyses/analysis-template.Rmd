...
```{r analysis_setup, echo=FALSE, cache=TRUE}
...
```{r init_muts, fig.width=fig.dim, cache=TRUE, depends="analysis_setup"}
...
Now, run longer:
```{r run_longer, cache=TRUE, depends="init_muts"}
...
```{r sample_muts, fig.width=fig.dim, cache=TRUE, depends="analysis_setup"}
