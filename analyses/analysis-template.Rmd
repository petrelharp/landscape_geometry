...
```{r expansion}
# plot:
matplot( sim$summary.times, sim$summaries[["radius"]][,c("aA","AA")], type='l', lty=1, col=seq_along(sim$genotypes)[-1],
        xlab="generation", main='radius', ylab='distance (m)')
legend( "bottomright", legend=pop$genotypes[-1], lty=1, col=seq_along(sim$genotypes)[-1])
...
A useful measure of the geometry of the habitat
...
```{r volume}
matplot( sim$summary.times, sim$summaries[["volume"]][,c("aA","AA")], type='l', lty=1, col=seq_along(sim$genotypes)[-1],
        xlab="generation", main='volume', ylab='volume (m^2)')
legend( "bottomright", legend=pop$genotypes[-1], lty=1, col=1:2)

geoms <- data.frame( time=sim$summary.times, radius=sim$summaries[["radius"]][,"AA"], volume=sim$summaries[["volume"]][,"AA"] )
with( geoms, plot( radius, volume, 
